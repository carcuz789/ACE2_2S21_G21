...
function insertdata(data){
    ...
    const FPS = "INSERT INTO DATA (DIA,peso,contador,TTRANS,fechafin,fechaini,horafin,horainicoi,usuario,cardiaco) VALUES ( '"+myArr[0]+"',"+myArr[1]+","+myArr[2]+","+myArr[3]+",'"+myArr[4]+"','"+myArr[5]+"','"+myArr[6]+"','"+myArr[7]+"','"+myArr[8]+"',"+myArr[9]+" )"; 
    executeSQL("INSERT INTO DATA (DIA,peso,contador,TTRANS,fechafin,fechaini,horafin,horainicoi,usuario,cardiaco)   VALUES ( '"+myArr[0]+"',"+myArr[1]+","+myArr[2]+","+myArr[3]+",'"+myArr[4]+"','"+myArr[5]+"','"+myArr[6]+"','"+myArr[7]+"','"+myArr[8]+"',"+myArr[9]+" )", (err, data) => {
    if (err)
      console.error(err);
